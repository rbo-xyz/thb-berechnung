...
def export_protocol(df300_new,
    ...
    try:
        ...
        footer = ["\n<<---------------------------------------------------------------->>",
                  ...
                  f"Empirische Std. (Freiheitsgrad n-1) einer einzelnen Höhendifferenz 1σ: {infos_height[2]} m",
                  f"Mittlere Höhendifferenz über Trig. Höhenbestimmung inkl. 1σ mittlere Std.: {infos_height[1]} m ± {round(infos_height[2]/np.sqrt(18), 4)} m",
                  f"Mittlere Höhendifferenz (Lage 1) inkl. 1σ mittlere Std.: {infos_height[3]} m ± {round(infos_height[4]/np.sqrt(18), 4)} m",
                  f"Mittlere Höhendifferenz (Lage 2) inkl. 1σ mittlere Std.: {infos_height[5]} m ± {round(infos_height[6]/np.sqrt(18), 4)} m",
                  "<<---------------------------------------------------------------->>",
                  "Schrägdistanzstatistik der Auswertung:",
                  f"Empirische Std. (Freiheitsgrad n-1) einer einzelnen Schrägdistanz 1σ: {infos_sd[1]} m",
                  f"Mittlere Schrägdistanz inkl. 1σ mittlere Std.: {infos_sd[0]} m ± {round(infos_sd[1]/np.sqrt(18), 4)} m",
                  f"Mittlere Schrägdistanz (Lage 1) inkl. 1σ mittlere Std.: {infos_sd[2]} m ± {round(infos_sd[3]/np.sqrt(18), 4)} m",
                  f"Mittlere Schrägdistanz (Lage 2) inkl. 1σ mittlere Std.: {infos_sd[4]} m ± {round(infos_sd[5]/np.sqrt(18), 4)} m",
                  "<<---------------------------------------------------------------->>",
                  "Refraktionskoeffizientenstatistik der Auswertung:",
                  f"Empirische Std. (Freiheitsgrad n-1) eines einzelnen Refraktionskoeffizienten 1σ: {infos_k[1]}",
                  f"Mittlerer Refraktionskoeffizient k inkl. 1σ mittlere Std.: {infos_k[0]} ± {round(infos_k[1]/np.sqrt(18), 4)}",
                  f"Mittlerer Refraktionskoeffizient k (Lage 1) inkl. 1σ mittlere Std.: {infos_k[2]} ± {round(infos_k[3]/np.sqrt(18), 4)}",
                  f"Mittlerer Refraktionskoeffizient k (Lage 2) inkl. 1σ mittlere Std.: {infos_k[4]} ± {round(infos_k[5]/np.sqrt(18), 4)}",
                  "<<---------------------------------------------------------------->>",
